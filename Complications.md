...
### d20 Complications
- A powerful creature takes notice.
- An authority figure steps in.
- Something important is broken.
- An ally makes things worse.
- A bystander gets involved.
- A rival enters the Scene.
- An enemy gains an advantage.
- A hidden threat is revealed.
- A misunderstanding occurs.
- The environment turns hostile.
- The situation becomes public, personal, or urgent.
- A resource is lost, spent, damaged, or stolen.
- A tool, weapon, ability, vehicle, or contact stops acting as expected.
- A secret is threatened or revealed.
- A party member's Vice is Invoked.
- An existing threat advances.
- Time or a clock advances.
- A path becomes blocked.
- A foe gathers strength.
- 