...
When a Creature whose Level is less than or equal to the Party's Level (or the highest level character in the Party) experiences a Morale Trigger, they must make a Morale check. If they fail, their Morale score decreases by 1. If their Morale reaches 0, they **Panic**.

### Player Characters

When a Player Character experiences a Morale Trigger, they must make a Willpower Resistance check. If they fail, their Willpower is reduced by 1 point. If a Player is reduced to 0 Willpower, they **Panic**.
